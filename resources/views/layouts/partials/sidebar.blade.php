<div class="sidebar d-flex flex-column">
    ...
    <div class="p-4">
        <button type="button" class="btn btn-salir w-100 d-flex align-items-center justify-content-center border-0" data-bs-toggle="modal" data-bs-target="#logoutModal">
            Salir
        </button>
    </div>
</div>
