                ...
                <div class="modal-body p-4 bg-white">
                   <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="vin" id="vin" maxlength="17" class="form-control border-0 bg-light p-3" style="border-radius: 12px;" required>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label fw-bold small text-muted">NÚMERO DE PLACAS *</label>
                            <input type="text" name="license_plate" id="license_plate" class="form-control border-0 bg-light p-3" style="border-radius: 12px;" required>
                        </div>
                        <div class="col-md-12">
                            <label class="form-label fw-bold small text-muted">PROPIETARIO *</label>
                            <select name="owner_id" id="selectDueno" class="form-select border-0 bg-light p-3" style="border-radius: 12px;" required>
                                <option value="">Seleccionar propietario...</option>
                            </select>
                        </div>
                        <div class="col-md-4">
                            <label class="form-label fw-bold small text-muted">MARCA *</label>
                            <input type="text" name="brand" id="brand" class="form-control border-0 bg-light p-3" style="border-radius: 12px;" placeholder="Ej: Honda" required>
                        </div>
                        <div class="col-md-5">
                            <label class="form-label fw-bold small text-muted">MODELO *</label>
                            <input type="text" name="model" id="model" class="form-control border-0 bg-light p-3" style="border-radius: 12px;" placeholder="Ej: Civic" required>
                        </div>
                        <div class="col-md-3">
                            <label class="form-label fw-bold small text-muted">AÑO *</label>
                            <input type="number" name="year_model" id="year_model" min="1900" max="2027" class="form-control border-0 bg-light p-3" style="border-radius: 12px;" placeholder="2024" required>
                        </div>
                    </div>
                </div>
